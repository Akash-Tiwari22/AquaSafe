...
const WATER_QUALITY_STANDARDS = {
  ...
  arsenic: { max: 10, unit: 'µg/L' },
  lead: { max: 10, unit: 'µg/L' },
  mercury: { max: 1, unit: 'µg/L' },
  cadmium: { max: 3, unit: 'µg/L' },
  chromium: { max: 50, unit: 'µg/L' },
  nickel: { max: 20, unit: 'µg/L' },
  copper: { max: 1000, unit: 'µg/L' },
  zinc: { max: 3000, unit: 'µg/L' },
  iron: { max: 300, unit: 'µg/L' },
  manganese: { max: 100, unit: 'µg/L' },
