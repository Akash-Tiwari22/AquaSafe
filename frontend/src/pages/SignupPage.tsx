      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          <div className="flex items-center justify-center space-x-2 mb-4">
            ...
            <span className="text-3xl font-bold text-dark-blue">AquaSafe</span>
          </div>
          <h2 className="text-2xl font-bold text-foreground">Create your account</h2>
          <p className="text-muted-foreground mt-2">
            Join AquaSafe to start analyzing water quality data
          </p>
        </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start space-x-2">
                  ...
                  <Label htmlFor="subscribeNewsletter" className="text-sm text-muted-foreground">
                    Subscribe to our newsletter for water quality insights and updates
                  </Label>
                </div>
              </div>
